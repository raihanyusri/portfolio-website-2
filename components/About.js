...
export default function About() {
    return (
        <div className="bg-gray-100 p-5 rounded-3xl shadow-lg">
                    ...
                    <div className="flex justify-between">
                        <div>
                            ...
                            <div className="flex items-baseline pl-2">
                                ...
                                <div className="flex flex-col icon-container mr-1">
                                    <Image alt="icon" width={12} height={12} className="h-10 w-10" src="/icons/go.svg" />
                                    <p className="icon-text text-xs">Go</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-baseline pl-2">
                                ...
                                <div className="flex flex-col icon-container">
                                    ...
                                    <p className="icon-text text-xs">Spring Boot</p>
                                </div>
                                <div className="flex flex-col icon-container mr-2">
                                    <Image alt="icon" width={12} height={12} className="h-8 w-8" src="/icons/ionic.svg" />
                                    <p className="icon-text text-xs">Ionic</p>
                                </div>
                                <div className="flex flex-col icon-container mr-1">
                            ...
                            <div className="flex items-baseline pl-2">
                                ...
                                <div className="flex flex-col icon-container">
                                    <Image alt="icon" width={12} height={12} className="h-9 w-9" src="/icons/postgres.svg" />
                                    <p className="icon-text text-xs">PostgreSQL</p>
                                </div>
                                <div className="flex flex-col icon-container mr-2">
